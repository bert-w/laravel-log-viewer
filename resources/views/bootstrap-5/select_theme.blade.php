...
<script>
     ...
     */
    document.documentElement.dataset.bsTheme = localStorage.getItem('log_viewer.theme');
    document.querySelectorAll('[data-bs-theme-value]').forEach(function (item) {
        item.addEventListener('click', function () {
            localStorage.setItem('log_viewer.theme', this.dataset.bsThemeValue);
            document.documentElement.dataset.bsTheme = this.dataset.bsThemeValue;
        });
    });
</script>
